...
publication: '*Automatic Detection for Healthy and Unhealthy Kidneys on Abdominal CT Images using Machine Learning Algorithm* (International Journal of Computer Applications (0975 – 8887) Volume 173 – No.2, September 2017 )'
...
summary: Developed an SVM-based MATLAB approach to classify healthy and unhealthy kidneys in CT images after region-growing segmentation, achieving **73.3% accuracy** on 70 images.
...
links:
  - type: pdf
    url: "https://www.ijcaonline.org/archives/volume173/number2/tulin-2017-ijca-915247.pdf"
#   - type: code
#     url: ""
